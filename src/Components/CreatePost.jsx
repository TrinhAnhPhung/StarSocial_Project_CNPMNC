...
const CreatePost = () => {
    ...
    const linkBackend = import.meta.env.VITE_Link_backend || "http://localhost:5000"; // Fallback
    ...
    const handleSharePost = async () => {
        ...
        // ✅ SỬA LỖI 1: Lấy 'token', không phải 'id'
        ...
        // ❌ SỬA LỖI 2: Xóa dòng này. Backend sẽ tự lấy user_id từ token.
        ...
        try {
            const res = await axios.post(`${linkBackend}/api/posts`, formData, {
                headers: {
                    ...
                    // (Axios tự động đặt cái này khi bạn gửi FormData)
                    
                    // ✅ SỬA LỖI 3: Thêm Authorization header
