...
const NotificationBell = ({ isCollapsed = false }) => {
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="relative p-0 rounded-lg transition-all duration-300 hover:scale-110 hover:bg-gray-100 active:scale-95"
          title="Thông báo"
        >
          <span className="material-icons text-2xl transition-transform duration-300 hover:rotate-12">
            notifications
          </span>
          {unreadCount > 0 && (
        ...
        {isOpen && (
          <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 max-h-96 overflow-hidden flex flex-col animate-in slide-in-from-top-2 duration-300">
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 max-h-96 overflow-hidden flex flex-col animate-in slide-in-from-top-2 duration-300">
          <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-blue-50 to-purple-50">
            <h3 className="font-semibold text-gray-800 flex items-center gap-2">
              <span className="material-icons text-blue-600">notifications</span>
              Thông báo
