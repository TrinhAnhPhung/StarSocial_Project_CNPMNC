...
export default function Profile() {
  ...
  }, [avatarScale, headerOpacity, menuItemsOpacity]);
            ...
            {userData && (
              <>
                  ...
                  <Animated.View style={[styles.avatarContainer, { transform: [{ scale: avatarScale }] }]}>
                    <LinearGradient
                      colors={colorScheme === 'dark' 
                        ? [PRIMARY_COLOR_DARK + '50', PRIMARY_COLOR_DARK + '30'] 
                        : [PRIMARY_COLOR_LIGHT + '30', PRIMARY_COLOR_LIGHT + '20']}
                      start={{ x: 0, y: 0 }}
                      end={{ x: 1, y: 1 }}
                ...
                <Animated.View style={[styles.section, { opacity: menuItemsOpacity }]}>
                  <TouchableOpacity
                    style={[styles.menuItem, { backgroundColor: theme.Text_color + '10', borderLeftWidth: 4, borderLeftColor: primaryColor }]}
                  ...
                  >
                    <View style={styles.menuItemContent}>
                      <MaterialIcons name="settings" size={24} color={primaryColor} />
                      <Text style={[styles.menuText, { color: theme.Text_color }]}>
                        Cài đặt
                      </Text>
                    </View>
